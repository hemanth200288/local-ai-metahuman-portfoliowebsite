###############################################################################
#  Configuration Parsing — CLI Arguments + YAML Configuration
###############################################################################
...
def str_or_int(value):
    """Try to convert to int, return str if it fails"""
    try:
        return int(value)
    except ValueError:
        return value
...
def parse_args():
    ...
    parser.add_argument('--REF_FILE', type=str, default="en-US-GuyNeural",
                        help="Voice model ID or reference file name")
    parser.add_argument('--REF_TEXT', type=str, default=None)
    parser.add_argument('--TTS_SERVER', type=str, default='http://127.0.0.1:9880')
    parser.add_argument('--system_prompt', type=str, default='You are a helpful knowledge assistant. Please respond in English concisely and in a conversational tone.',
